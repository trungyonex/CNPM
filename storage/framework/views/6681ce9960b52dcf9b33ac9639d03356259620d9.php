	...
	<body>
		<div class="header">
			<nav class="navbar navbar-expand-md bg-white navbar-white">
				<a class="navbar-brand" href="<?php echo e(route('index')); ?>">TTT</a>
				<div class="logo">
				...
				<div class="collapse navbar-collapse" id="collapsibleNavbar">
					<ul class="navbar-nav">
						<li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('index')); ?>"><b>Home</b></a>
						</li>
						<li class="nav-item">
        ...
        <div class="footer" style="height: 200px; background-color: #FFF3E2;">
            ...
            <a class="navbar-brand" href="<?php echo e(route('index')); ?>" style="positon: absolute; margin-top: 100px; margin-left: 100px;">TTT</a>
...
<?php /**PATH C:\xampp\htdocs\local\TrungProject\resources\views/layouts/user.blade.php ENDPATH**/ ?>